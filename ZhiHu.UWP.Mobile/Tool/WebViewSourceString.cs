...
{
    public static class WebViewSourceString
    {
        public static readonly DependencyProperty SourceStringProperty =
DependencyProperty.RegisterAttached("SourceString", typeof(string), typeof(WebViewSourceString), new PropertyMetadata("", OnSourceStringChanged));
